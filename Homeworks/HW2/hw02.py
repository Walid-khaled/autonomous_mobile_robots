...
class MinimalPublisher(Node):
    ...
    def reference_path_follower_diff_drive_init(self, duration=50, r_distance=1.3
    ...
    def plot(self, actual_q, odom, t):
        ...
        # plt.subplot(2, 2, 3)
        # plt.plot(t, actual_q[:,2], label="yaw")
        # plt.plot(t, odom[:,2], label="odom")
        # plt.title('yaw analytical vs time', fontsize=10)
        # plt.xlabel('time(s)', fontsize=10)
